...
if (isset($_POST['update'])) {
    ...
    $age = mysqli_real_escape_string($mysql_connection, $_POST['age']);
    ...
    if (empty($name) || empty($age) || empty($email)) {
        ...
        $result = mysqli_query($mysql_connection, "UPDATE users SET `name` = '$name', `age` = '$age', `email` = '$email' WHERE `id` = $id");
